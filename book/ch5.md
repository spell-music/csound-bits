...
> dac $ sched bam $ withDur 0.1 $ mconcat [metroE 2, metroE 1.5, metroE $ 3/7]
~~~
...
> dac $ sched oscInstr $ withDur 0.1 $ mconcat 
	[devt 440 $ metroE 2, devt 660 $ metroE 1.5, devt 220 $ metroE 0.5]
~~~
...
> dac $ mlp 2500 0.1 $ sched oscInstr $ withDur 0.1 $ 
	oneOf (fmap (* 220) [1, 9/8, 5/4, 3/2, 2]) $ metroE 8
~~~
...
~~~
> dac $ sched oscInstr $ withDur 0.2 $ fmap cpsmidinn $ iterateE 30 (+1) $ metroE 4
~~~
