...
import Csound.Base hiding (hvs1, hvs2, hvs3)
import qualified Csound.Base as C(hvs1, hvs2, hvs3)
...
f = hvs1 [[100, 0.1], [300, 0.1], [300, 0.5], [300, 0.8], [400, 0.8], [600, 0.9]]

g = hvs2 [[[100, 0.1, 0.3], [800, 0.1, 0.5], [1400, 0.1, 0.8]], 
		  [[100, 0.5, 0.3], [800, 0.5, 0.5], [1400, 0.5, 0.8]], 
		  [[100, 0.8, 0.3], [800, 0.8, 0.5], [1400, 0.8, 0.8]]]

xs = [	[[100, 0.1, 0.3], [800, 0.1, 0.5], [1400, 0.1, 0.8]], 
		[[100, 0.5, 0.3], [800, 0.5, 0.5], [1400, 0.5, 0.8]], 
		[[100, 0.8, 0.3], [800, 0.8, 0.5], [1400, 0.8, 0.8]]
	 ]
